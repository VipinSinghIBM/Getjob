    ...
    <div class="container-fluid px-0">
      <div class="row ">
        ...
        <div class="col-sm-12 col-md-3 mr-auto">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <p class="font-weight-bold"><i class="fas fa-bullhorn"></i> Latest News</p>
            </div>
            <div class="card-body">
              <div class="top-employers">
              @foreach ($topEmployers as $employer)
                <div class="top-employer">
                  <marquee style="font-family: Book Antiqua; color: Blue" direction="up" height="80" behavior="alternate" >
                    <h5> <img src="{{asset('images/blink.gif')}}" width="50px" alt="Natural"/> New Updates Availble Soon </h5>
                  </marquee>
                </div> 
              @endforeach
              </div>
